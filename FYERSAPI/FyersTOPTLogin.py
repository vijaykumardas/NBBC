...
FY_ID = "YV16724"  # Your fyers ID
APP_ID_TYPE = "2"  # Keep default as 2, It denotes web login
TOTP_KEY = "3QNT3JP3XTFFGA27EENOEC2KU7ZNN7HP"  # TOTP secret is generated when we enable 2Factor TOTP from myaccount portal
PIN = "1778"  # User pin for fyers account
APP_ID = "QCT5HT02YR"#"7ZZHXHVNKN"  # App ID from myapi dashboard is in the form appId-appType. Example - EGNI8CE27Q-100, In this code EGNI8CE27Q will be APP_ID and 100 will be the APP_TYPE
...
a_string = 'QCT5HT02YR-100:WTBPRRCNUR' # NEW
...
def main():
    ...
    if send_otp_result[0] != SUCCESS:
        ...
        print("send_login_otp success" + str(send_otp_result))
    ...
    if generate_totp_result[0] != SUCCESS:
        ...
        print("generate_totp success : " + str(generate_totp_result))
    sys.exit()
